...
--CREATE STRUCTURE FOR TABLE public.classification
CREATE TABLE public.classification(
    classification_id INT GENERATED BY DEFAULT AS IDENTITY,
    classification_name CHARACTER VARYING NOT NULL,
    CONSTRAINT classification_pk PRIMARY KEY (classification_id)
);
--CREATE STRUCTURE FOR TABLE public.inventory
...
-- SET RELATIONSHIP BETWEEN   public.inventory and public.classification
...
--CREATE STRUCTURE FOR TABLE public.account
...
VALUES ('Custom'),
    ...
    ('Truck'),
    ('Sedan');
--DATA for table public.inventory
