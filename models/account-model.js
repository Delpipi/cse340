...
async function updatePasswordAccount(account_id, account_password) {
    try {
        ...
        console.error("updatePasswordAccount error: " + error)
    }
}

module.exports = { registerAccount, checkExistingEmail, getAccountByEmail, updateAccount, updatePasswordAccount, getAccountById}